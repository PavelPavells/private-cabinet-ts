 ...
 */
export const fetchingDataRequest = (): TopNavActions => ({
 ...
 */
export const fetchingDataSuccess = (data: any): TopNavActions => ({
 ...
 */
export const fetchingDataFailure = (error: any): TopNavActions => ({
 ...
 */
export const fetchDataTopNav = (data: TopNavState) => async (dispatch: Dispatch<TopNavActions>) => {
