...
interface NewPasswordProps {
    readonly newPassword: (password: any) => void;
    readonly data: any;
}
...
class NewPassword extends React.PureComponent<NewPasswordProps, Partial<NewPasswordState>> {
    ...
    private clickForm = () => {
        ...
        this.props.newPassword(password);
    };
    ...
    public render() {
        ...
        if (this.props.data.length === 0 || this.props.data.success === 'false' || pass === '') {
            return (
                /**
                                ...
                                <label>
                                    {err ? (
                                        <div className="auth__field field">
                                            ...
                                            <div onClick={this.showOrHidePasswordRepeat} className="inaccess" />
                                        </div>
                                    ) : (
                                        <div className="auth__field field">
                                            <input
