...
import Micro from '../../../../images/news_micro.svg';
                        ...
                        <div className="block-container">
                            <div className="block-element" style={{ padding: '15px' }}>
                                ...
                                <div className="block-element__info">
                                    <div className="block-element__title news-title">
                                        <span className="offer">Новости</span>
                                        <span className="date" style={{ color: '#8b9298' }}>
                                            10 Августа 2020
                                        </span>
                                    </div>
                                    <div className="block-element__subtitle" style={{ margin: '0px 0px 12px' }}>
                                        <span>Автоматический шлагбаум «RBA» по выгодной цене</span>
                                    </div>
                                    <div className="block-element__description">
                                        <span style={{ color: '#8b9298', paddingTop: '10px' }}>
                                            До 31 августа 2020 года мы снижаем цену!
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="block-element" style={{ padding: '0px' }}>
                                <ul className="block-element__info">
                                    <li
                                        style={{
                                    ...
                                    >
                                        ...
                                        <span style={{ color: '#1d68d9', marginRight: '19px' }}>28.10.2020</span>
                                        <span>Разработка первой электронной платы для устройств бесконтактно</span>
                                    </li>
                                    <li
                                        style={{
                                            borderBottom: '1px solid #ebeff3',
